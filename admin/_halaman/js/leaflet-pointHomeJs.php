...
<script src="admin/assets/js/leaflet-panel-layers-master/src/leaflet-panel-layers.js"></script>
<script src="admin/assets/js/leaflet.ajax.js"></script>
...
<script type="text/javascript">
    ...
    <?php
        $arrayKab[] = '{
			...
			layer: new L.GeoJSON.AJAX(["admin/assets/unggah/geojson/' . $row->geojson_kabupaten . '"],{onEachFeature:popUp,style: myStyle' . $row->id_kabupaten . ',pointToLayer: featureToMarker }).addTo(map)
			}';
    }
    ?>
    ...
    // marker
    var myIcon = L.icon({
        iconUrl: './admin/assets/icons/marker.png',
        iconSize: [38, 45],
    });
    <?php
